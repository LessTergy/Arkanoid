...
- Текущий этап: [Этап 2 — изолированная механика мяча](Stages/02-ball.md)
- Этап 0 завершён: 15 из 15 задач, Gate 0 пройден.
- Этап 1 завершён: 8 из 8 задач, Gate 1 пройден.
- Следующая задача: P2.7 — ограничить почти горизонтальные и почти вертикальные траектории.
...
| [2](Stages/02-ball.md) | Изолированная механика мяча | В работе |
