...
- собирается в готовые Android- и iOS-билды и сопровождается понятным README.
...
1. Первый релиз и критерии готовности ориентированы на Android и iOS, портретную ориентацию и базовое игровое поле 9:16. Референс для арта и UI — 1080 × 1920 px; другие разрешения и пропорции поддерживаются адаптацией камеры и UI. Gameplay-логика не должна зависеть от конкретной мобильной ОС или устройства ввода.
2. Основное управление — сенсорное. Keyboard/gamepad bindings, созданные на этапе 0, сохраняются для проверки в Editor и как дополнительный способ ввода.
...
- Android- и iOS-билды, README и короткое демонстрационное видео/GIF.

## Не входит в первую версию

- отдельная адаптация для Windows desktop и WebGL;
