...
- [x] `P1.7` Проверить одинаковую скорость при разных frame rates и отсутствие дрожания у границ.
- [x] `P1.8` Добавить тест чистой функции расчёта/clamp новой позиции.
...
- [x] Платформа управляется касанием; keyboard/gamepad доступны для проверки в Editor.
- [x] Не выходит за левую и правую границы.
- [x] Поведение не зависит заметно от render frame rate.
