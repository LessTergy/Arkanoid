...
- [ ] `P12.4` Выполнить ручную матрицу портретных разрешений минимум 9:16 и 9:19.5, включая устройство с вырезом экрана; проверить Canvas scaling, `Screen.safeArea` и границы камеры.
