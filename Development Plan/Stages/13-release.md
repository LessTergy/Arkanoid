...
- [ ] `P13.7` Подготовить release Android- и iOS-билды из зафиксированного commit; локальная сборка и подпись iOS требуют macOS и Xcode.
...
- [ ] Android- и iOS-билды запускаются на поддерживаемых устройствах.
